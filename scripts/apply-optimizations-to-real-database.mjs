...
async function applyOptimizationsToRealDatabase() {
  ...
  try {
    ...
    const adminTemplate = {
      ...
      masterChecklist: [
        // Morning routine
        { id: 'mc-morning-001', text: 'Wake up at target time', category: 'morning', completed: false },
        { id: 'mc-morning-002', text: 'Morning meditation/prayer', category: 'morning', completed: false },
        { id: 'mc-morning-003', text: 'Review daily goals', category: 'morning', completed: false },
        
        // Work focus
        { id: 'mc-work-001', text: 'Check and respond to priority emails', category: 'work', completed: false },
        { id: 'mc-work-002', text: 'Complete most important task', category: 'work', completed: false },
        { id: 'mc-work-003', text: 'Update project status', category: 'work', completed: false },
        
        // Tech/Development
        { id: 'mc-tech-001', text: 'Code review and commits', category: 'tech', completed: false },
        { id: 'mc-tech-002', text: 'Learn something new (tech)', category: 'tech', completed: false },
        
        // House/Personal
        { id: 'mc-house-001', text: 'Tidy living space', category: 'house', completed: false },
        { id: 'mc-house-002', text: 'Meal prep/planning', category: 'house', completed: false },
        
        // Wrap-up
        { id: 'mc-wrapup-001', text: 'Review day accomplishments', category: 'wrapup', completed: false },
        { id: 'mc-wrapup-002', text: 'Plan tomorrow priorities', category: 'wrapup', completed: false }
      ],
      
      // Optimized Habit Break Checklist
      habitBreakChecklist: [
        { id: 'hb-lsd-001', text: 'Avoided mindless social media', category: 'lsd', completed: false },
        { id: 'hb-lsd-002', text: 'Limited news consumption', category: 'lsd', completed: false },
        { id: 'hb-financial-001', text: 'Tracked expenses', category: 'financial', completed: false },
        { id: 'hb-financial-002', text: 'No impulse purchases', category: 'financial', completed: false },
        { id: 'hb-youtube-001', text: 'Productive YouTube only', category: 'youtube', completed: false },
        { id: 'hb-time-001', text: 'Used time blocking effectively', category: 'time', completed: false }
      ],
      ...
      timeBlocks: [
        { id: 'tb-06h-001', hour: 6, activities: ['Morning routine', 'Exercise'] },
    ...
    const publicTemplate = {
      ...
      masterChecklist: [
        { id: 'mc-morning-001', text: 'Morning routine', category: 'morning', completed: false },
        { id: 'mc-work-001', text: 'Complete important task', category: 'work', completed: false },
        { id: 'mc-house-001', text: 'Tidy space', category: 'house', completed: false },
        { id: 'mc-wrapup-001', text: 'Review day', category: 'wrapup', completed: false }
      ],
      
      habitBreakChecklist: [
        { id: 'hb-lsd-001', text: 'Mindful social media use', category: 'lsd', completed: false },
        { id: 'hb-financial-001', text: 'Track spending', category: 'financial', completed: false },
        { id: 'hb-time-001', text: 'Use time wisely', category: 'time', completed: false }
      ],
    ...
    for (const user of users) {
      ...
      if (updateResult.modifiedCount > 0) {
        console.log(`   ✅ Updated ${user.email} with optimized data for ${today}`);
      } else {
