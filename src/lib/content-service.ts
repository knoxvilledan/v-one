      ...
      const publicTemplate: ContentTemplateType = {
        ...
        content: {
          ...
          habitBreakChecklist: [
            {
              id: "hb-lsd-001",
              text: "Track bad habit you want to break",
              category: "lsd",
              order: 1,
            },
            {
              id: "hb-financial-001",
              text: "Avoid unnecessary spending",
              category: "financial",
              order: 2,
            },
            {
              id: "hb-youtube-001",
              text: "Avoid mindless YouTube browsing",
              category: "youtube",
              order: 3,
            },
            {
              id: "hb-time-001",
              text: "Stop wasting time on social media",
              category: "time",
              order: 4,
            },
            {
              id: "hb-entertainment-001",
              text: "Limit excessive entertainment",
          ...
          workoutChecklist: [
            ...
            {
              id: "wo-yoga-001",
              text: "Yoga and flexibility",
              category: "yoga",
              order: 3,
            },
            {
              id: "wo-stretching-001",
              text: "Stretching and recovery",
              category: "stretching",
              order: 4,
            },
            {
              id: "wo-walking-001",
              text: "Walking or light activity",
              category: "walking",
              order: 5,
            },
          ],
      ...
      const adminTemplate: ContentTemplateType = {
        ...
        content: {
          ...
          habitBreakChecklist: [
            ...
            {
              id: "hb-entertainment-101",
              text: "mindless entertainment",
              category: "entertainment",
              order: 6,
            },
          ],
          workoutChecklist: [
            ...
            {
              id: "wo-sports-101",
              text: "Active sports or activities",
              category: "sports",
              order: 6,
            },
          ],
